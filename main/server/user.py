...
def process_login_v1(user_info):
    ...
    if user.password != user_info['password']:
        print(user_info['password'], user.password)
...
# get
def process_forgetpassword_v1(user_info):
...
# put
def process_changpassword_v1(user_info):
    response_data = {"username": user_info['username'], "new_password":None,"message": 'Information error'}
    status_code = 200
